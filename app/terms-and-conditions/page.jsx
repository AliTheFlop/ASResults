    ...
    return (
        <div className="container mx-auto py-16 px-4 md:px-6">
            <div className="max-w-4xl mx-auto prose prose-lg text-muted-foreground">
                ...
                <h2>General Terms</h2>
                <p>
                    By accessing and placing an order with AS Results, you
                    ...
                    any email or other type of communication between you and AS
                    Results.
                </p>
                <p>
                    Under no circumstances shall AS Results team be liable for
                    ...
                    materials on this site, even if AS Results team or an
                ...
                <p>
                    AS Results will not be responsible for any outcome that may
                ...
                <h2>License</h2>
                <p>
                    AS Results grants you a revocable, non-exclusive,
                    non-transferable, limited license to download, install and
                    use the website strictly in accordance with the terms of
                    this Agreement.
                </p>
                <p>
                    These Terms & Conditions are a contract between you and AS
                    Results (referred to in these Terms & Conditions as &quot;AS
                    Results&quot;, &quot;us&quot;, &quot;we&quot; or
                    &quot;our&quot;), the provider of the AS Results website and
                    the services accessible from the AS Results website (which
                    are collectively referred to in these Terms & Conditions as
                    the &quot;AS Results Service&quot;).
                </p>
                <p>
                    You are agreeing to be bound by these Terms & Conditions. If
                    you do not agree to these Terms & Conditions, please do not
                    use the AS Results Service. In these Terms & Conditions,
                    &quot;you&quot; refers both to you as an individual and to
                ...
                <ul>
                    ...
                    <li>
                        ...
                        “us,” or “our,” it refers to AS Results, that is
                        responsible for your information under this Terms &
                        Conditions.
                    </li>
                    <li>
                        Country: where AS Results or the owners/founders of AS
                        Results are based, in this case is{" "}
                    </li>
                    <li>
                        Device: any internet connected device such as a phone,
                        tablet, computer or any other device that can be used to
                        visit AS Results and use the services.
                    </li>
                    <li>
                        Service: refers to the service provided by AS Results as
                    ...
                    <li>
                        Website: AS Results&apos;s site, which can be accessed
                        via this URL: https://asresults.com
                    </li>
                    <li>
                        You: a person or entity that is registered with AS
                        Results to use the Services.
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        (including any notice of copyright or trademark) of AS
                        Results or its affiliates, partners, suppliers or the
                        licensors of the website.
                    </li>
                </ul>
                <h2>Return and Refund Policy</h2>
                <p>
                    Thanks for shopping at AS Results. We appreciate the fact
                ...
                <p>
                    ...
                    conditions that apply to transactions at AS Results.
                    We&apos;ll be as brief as our attorneys will allow. The main
                    thing to remember is that by placing an order or making a
                    purchase at AS Results, you agree to the terms along with AS
                    Results&apos;s Privacy Policy.
                </p>
                <p>
                ...
                <p>
                    ...
                    AS Results with respect to the website shall remain the sole
                    and exclusive property of AS Results.
                </p>
                <p>
                    AS Results shall be free to use, copy, modify, publish, or
                    redistribute the Suggestions for any purpose and in any way
                    without any credit or any compensation to you.
                </p>

                <h2>Results Guarantee & Payment Terms</h2>
                <p>
                    AS Results offers a conditional performance-based guarantee.
                    For clients on our “Results Guarantee” package, we commit to
                    delivering measurable results — typically defined as a
                    minimum number of leads or consultations — within a
                    pre-agreed timeframe.
                </p>

                <p>
                    If these results are not achieved, and the client has
                    followed all required steps (including providing timely
                    approvals, content, and communication), the final 50% of the
                    service fee will be waived.
                </p>

                <p>
                    The initial 50% upfront payment is non-refundable and covers
                    the strategic planning, ad creation, setup, copywriting, and
                    platform management required to deliver the campaign.
                </p>

                <p>
                    The guarantee is void if the client delays campaign launch,
                    withholds critical information, or fails to respond for more
                    than 7 business days during active delivery. All terms are
                    subject to written agreement prior to launch.
                </p>
                ...
                <p>
                    ...
                    controlled by AS Results. We are not responsible for the
                    ...
                    to that website&apos;s own rules and policies. Such third
                    parties may use their own cookies or other methods to
                    collect information about you.
                </p>

                <h2>Cookies</h2>
                <p>
                    AS Results uses &quot;Cookies&quot; to identify the areas of
                ...
                <p>
                    You acknowledge and agree that AS Results may stop
                    ...
                    specifically inform AS Results when you stop using the
                    Service. You acknowledge and agree that if AS Results
                ...
                <p>
                    AS Results reserves the right to modify, suspend or
                ...
                <p>
                    AS Results may from time to time provide enhancements or
                ...
                <p>
                    ...
                    functionalities of the website. You agree that AS Results
                ...
                <p>
                    You acknowledge and agree that AS Results shall not be
                    ...
                    thereof. AS Results does not assume and shall not have any
                ...
                <p>
                    AS Results may, in its sole discretion, at any time and for
                    any or no reason, suspend or terminate this Agreement with
                    or without prior notice.
                </p>
                <p>
                    This Agreement will terminate immediately, without prior
                    notice from AS Results, in the event that you fail to comply
                    with any provision of this Agreement. You may also terminate
                    this Agreement by deleting the website and all copies
                    thereof from your computer.
                </p>
                <p>
                    Upon termination of this Agreement, you shall cease all use
                    of the website and delete all copies of the website from
                    your computer.
                </p>
                <p>
                    Termination of this Agreement will not limit any of AS
                    Results&apos;s rights or remedies at law or in equity in
                ...
                <p>
                    You agree to indemnify and hold AS Results and its parents,
                ...
                <p>
                    ...
                    permitted under applicable law, AS Results, on its own
                    ...
                    statutory or otherwise, with respect to the website,
                    ...
                    to the foregoing, AS Results provides no warranty or
                    undertaking, and makes no representation of any kind that
                    the website will meet your requirements, achieve any
                ...
                <p>
                    Without limiting the foregoing, neither AS Results nor any
                    AS Results&apos;s provider makes any representation or
                    ...
                    or e-mails sent from or on behalf of AS Results are free of
                ...
                <p>
                    ...
                    liability of AS Results and any of its suppliers under any
                ...
                <p>
                    ...
                    event shall AS Results or its suppliers be liable for any
                    special, incidental, indirect, or consequential damages
                    whatsoever (including, but not limited to, damages for loss
                    of profits, for loss of data or other information, for
                    ...
                    connection with any provision of this Agreement), even if AS
                    Results or any supplier has been advised of the possibility
                    of such damages and even if the remedy fails of its
                    essential purpose.
                </p>
                <p>
                ...
                <p>
                    ...
                    other legal notices published by AS Results on the Services,
                    shall constitute the entire agreement between you and AS
                    Results concerning the Services. If any provision of this
                    ...
                    and AS Results&apos;s failure to assert any right or
                    provision under this Agreement shall not constitute a waiver
                    of such right or provision. YOU AND AS Results AGREE THAT
                ...
                <p>
                    ...
                    Agreement shall not effect a party&apos;s ability to
                ...
                <p>
                    AS Results reserves the right, at its sole discretion, to
                ...
                <p>
                    ...
                    no longer authorized to use AS Results.
                </p>

                <h2>Entire Agreement</h2>
                <p>
                    The Agreement constitutes the entire agreement between you
                    and AS Results regarding your use of the website and
                    supersedes all prior and contemporaneous written or oral
                    agreements between you and AS Results.
                </p>
                <p>
                    You may be subject to additional terms and conditions that
                    apply when you use or purchase other AS Results&apos;s
                    services, which AS Results will provide to you at the time
                ...
                <p>
                    ...
                    design, selection and arrangement thereof), are owned by AS
                    Results, its licensors or other providers of such material
                    ...
                    modified, reproduced, downloaded or distributed in any way,
                    in whole or in part, without the express prior written
                    permission of AS Results, unless and except as is expressly
                ...
                <p>
                    ...
                    YOUR OR AS Results&apos;s INTELLECTUAL PROPERTY RIGHTS. The
                    term “dispute” means any dispute, action, or other
                    controversy between you and AS Results concerning the
                ...
                <p>
                    In the event of a dispute, you or AS Results must give the
                    ...
                    via email to: ali@asresults.com . AS Results will send any
                    Notice of Dispute to you by mail to your address if we have
                    it, or otherwise to your email address. You and AS Results
                    will attempt to resolve any dispute through informal
                    negotiation within sixty (60) days from the date the Notice
                    of Dispute is sent. After sixty (60) days, you or AS Results
                    may commence arbitration.
                </p>

                <h2>Binding Arbitration</h2>
                <p>
                    If you and AS Results don&apos;t resolve any dispute by
                    ...
                    Any and all legal, accounting, and other costs, fees, and
                    expenses incurred by the prevailing party shall be borne by
                ...
                <p>
                    ...
                    non-proprietary and will become the sole property of AS
                    Results without any compensation or credit to you
                    whatsoever. AS Results and its affiliates shall have no
                    obligations with respect to such submissions or posts and
                    may use the ideas contained in such submissions or posts for
                ...
                <h2>Promotions</h2>
                <p>
                    AS Results may, from time to time, include contests,
                ...
                <p>
                    ...
                    AS Results. AS Results will be entitled to injunctive or
                    other equitable relief (without the obligations of posting
                    any bond or surety) in the event of any breach or
                    anticipatory breach by you. AS Results operates and controls
                    the AS Results Service from its offices in . The Service is
                    ...
                    Accordingly, those persons who choose to access the AS
                    Results Service from other locations do so on their own
                    ...
                    AS Results Privacy Policy) contains the entire
                    understanding, and supersedes all prior understandings,
                    between you and AS Results concerning its subject matter,
                ...
                <h2>Disclaimer</h2>
                <p>
                    AS Results is not responsible for any content, code or any
                    other imprecision.
                </p>
                <p>AS Results does not provide warranties or guarantees.</p>
                <p>
                    In no event shall AS Results be liable for any special,
                ...
                <p>
                    The AS Results Service and its contents are provided
                    &quot;as is&quot; and &quot;as available&quot; without any
                    warranty or representations of any kind, whether express or
                    implied. AS Results is a distributor and not a publisher of
                    the content supplied by third parties; as such, AS Results
                    ...
                    or merchandise provided through or accessible via the AS
                    Results Service. Without limiting the foregoing, AS Results
                    specifically disclaims all warranties and representations in
                    any content transmitted on or in connection with the AS
                    Results Service or on sites that may appear as links on the
                    AS Results Service, or in the products provided as a part
                    of, or otherwise in connection with, the AS Results Service,
                    including without limitation any warranties of
                    merchantability, fitness for a particular purpose or
                    non-infringement of third party rights. No oral advice or
                    written information given by AS Results or any of its
                    ...
                    limiting the foregoing, AS Results does not warrant that the
                    AS Results Service will be uninterrupted, uncorrupted,
                ...
                <ul>
                    <li>Via Email: ali@asresults.com</li>
                </ul>
            </div>
        </div>
    );
